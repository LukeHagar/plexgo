...
<!-- UsageSnippet language="go" operationID="createDownloadQueue" method="post" path="/downloadQueue" -->
```go
package main
...
**[*operations.CreateDownloadQueueResponse](../../models/operations/createdownloadqueueresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="getDownloadQueue" method="get" path="/downloadQueue/{queueId}" -->
```go
package main
...
**[*operations.GetDownloadQueueResponse](../../models/operations/getdownloadqueueresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="addDownloadQueueItems" method="post" path="/downloadQueue/{queueId}/add" -->
```go
package main
...
**[*operations.AddDownloadQueueItemsResponse](../../models/operations/adddownloadqueueitemsresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="listDownloadQueueItems" method="get" path="/downloadQueue/{queueId}/items" -->
```go
package main
...
**[*operations.ListDownloadQueueItemsResponse](../../models/operations/listdownloadqueueitemsresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="getItemDecision" method="get" path="/downloadQueue/{queueId}/item/{itemId}/decision" -->
```go
package main
...
**[*operations.GetItemDecisionResponse](../../models/operations/getitemdecisionresponse.md), error**
...
**[*operations.GetDownloadQueueMediaResponse](../../models/operations/getdownloadqueuemediaresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="removeDownloadQueueItems" method="delete" path="/downloadQueue/{queueId}/items/{itemId}" -->
```go
package main
...
**[*operations.RemoveDownloadQueueItemsResponse](../../models/operations/removedownloadqueueitemsresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="getDownloadQueueItems" method="get" path="/downloadQueue/{queueId}/items/{itemId}" -->
```go
package main
...
**[*operations.GetDownloadQueueItemsResponse](../../models/operations/getdownloadqueueitemsresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="restartProcessingDownloadQueueItems" method="post" path="/downloadQueue/{queueId}/items/{itemId}/restart" -->
```go
package main
...
**[*operations.RestartProcessingDownloadQueueItemsResponse](../../models/operations/restartprocessingdownloadqueueitemsresponse.md), error**
