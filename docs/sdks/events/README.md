...
<!-- UsageSnippet language="go" operationID="getNotifications" method="get" path="/:/eventsource/notifications" -->
```go
package main
...
**[*operations.GetNotificationsResponse](../../models/operations/getnotificationsresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="connectWebSocket" method="get" path="/:/websocket/notifications" -->
```go
package main
...
**[*operations.ConnectWebSocketResponse](../../models/operations/connectwebsocketresponse.md), error**
